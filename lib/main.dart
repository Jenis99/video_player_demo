...
import 'package:video_player_app/my_app.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:video_player_app/utils/navigation_utils/navigation.dart';
void main() {
  runApp(const MyApp());
}
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  var videos = [
    VideoItemModel(
        "Gordon Ramsay Cooked For Vladimir Putin", "The Late Show with Stephen Colbert\n1.1M views.2 weeks ago", "assets/youtube_one.jpg"),
    VideoItemModel("Hailee Steinfeld, Alesso - Let Me Go", "Hailee Steinfeld\n57M views.8 months ago", "assets/youtube_two.jpg"),
    VideoItemModel("Charlie Puth - Look At Me Now", "Lyricwood\n4.7M views.4 months ago", "assets/youtube_three.jpg")
  ];
        ...
        title: const Row(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Video Player Demo",
                style: TextStyle(color: Colors.black, letterSpacing: -1.0, fontWeight: FontWeight.w700),
              ),
            ),
          ],
        ),
